---
name: odoo-19
description: Odoo 19 development knowledge base with 18 specialized guides covering actions and automation, HTTP controllers, XML/CSV data files, API decorators, SQL constraints with `models.Constraint`, database indexes with `models.Index`, module structure, field types, manifests and asset bundles, mixins, ORM methods and recordsets, migration hooks and scripts, OWL frontend components, performance optimization, QWeb reports, security and ACLs, testing, transactions, translations, and XML views. Includes current Odoo 19 patterns for `ir.actions.*`, cron and server actions, routes and authentication, `noupdate`, API decorators, relational fields, wizards, reports, domains, CRUD, `_read_group`, savepoints, query-count assertions, PO files, kanban and QWeb templates, and XPath inheritance. Use when writing, reviewing, debugging, migrating, or optimizing Odoo 19 Python, XML, JavaScript, OWL, and module code.
